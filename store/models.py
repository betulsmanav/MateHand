...
class Post(models.Model):
    ...
    hashtag = models.ManyToManyField(Hashtag, through='PostHashtag')

    def __str__(self):
        return f"{self.room}---{self.user}---{self.content}"

class PostHashtag(models.Model):
    hashtag=models.ForeignKey(Hashtag,related_name='fatma', on_delete=models.CASCADE)
    post=models.ForeignKey(Post,related_name='osman', on_delete=models.CASCADE)
